...
def needs_accessible_mode() -> bool:
    ...
    - TERM=dumb
    - AXCLI_SCREEN_READER env var set
    ...
    if os.environ.get("TERM", "") == "dumb":
        return True
    if os.environ.get("AXCLI_SCREEN_READER", ""):
        return True
...
def _screen_reader_running() -> bool:
    ...
    # ponytail: pgrep check, no deps. False negative is fine — user can set AXCLI_SCREEN_READER=1
